            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Every farmstay is personally inspected and verified to ensure
                  quality, safety, and authentic experiences.
                </p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                our platform is personally inspected to ensure it meets our high
                standards for comfort, authenticity, and hospitality.
              </p>
